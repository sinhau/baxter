...
try
    baxterJ = RobotRaconteur.Connect('tcp://localhost:4664/BaxterJointServer/Baxter');
catch err
...
try
    baxterP = RobotRaconteur.Connect('tcp://localhost:4665/BaxterPeripheralServer/BaxterPeripherals');
catch err
