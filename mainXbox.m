...
% Baxter connections
baxter = RobotRaconteur.Connect('tcp://localhost:4695/BaxterServer/Baxter');
...
while(1) 
    ...
    [linVel_L,linVel_R,wristVel_L,wristVel_R,grip_L,grip_R,rightSide] = setDesiredInputXbox(xbox,rightSide,baxter);
